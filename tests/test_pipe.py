...
def test_unifier():
    num_pipe = Pipeline([("fs", tml.DtypeSel(dtype="numeric")), ("imp", tml.DfImputer(strategy="mean"))])
    cat_pipe = Pipeline([("fs", tml.DtypeSel(dtype="category")), ("imp", tml.DfImputer(strategy="most_frequent"))])
