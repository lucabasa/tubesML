...
def plot_learning_curve(
    estimator, X, y, scoring=None, ylim=None, cv=None, n_jobs=None, train_sizes=np.linspace(0.1, 1.0, 10), title=None
):
    """
...
def get_pdp(estimator, feature, data, grid_resolution=100):
    ...
    if isinstance(feature, tuple):
        ...
        raise TypeError(
            "This function does not support the calculation over multiple features. You can use directly the sklearn function for that."
        )
