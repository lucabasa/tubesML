...
class Stacker(BaseTransformer):
    ...
    estimators : list of tuples (name, estimator) (including pipelines).
                These estimators will generate the first layer of predictions
                
    final_estimator : estimator with a fit and a predict (or predict_proba) methods
                This estimator will create the final prediction
                
    cv : KFold (or similar) generator.
        The CV scheme to use to generate the first layer of predictions
        
    lay1_kwargs : (optional) dict,
    ...
    passthrough : bool or list, default=False.
